...
def process_question():
    try:
        ...
        file_path = os.path.join("Your File Path", file_name)
        ...
        if user_question:
            ...
            # Check if the response indicates no relevant data found
            if not response or "I don't have any information on that" in response:
